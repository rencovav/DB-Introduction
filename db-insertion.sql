...
((select max(investor_id) + 1 from investors i), 'Olga', 'Nezmarná', 30100, 1000, 190)
((select max(investor_id) + 1 from investors i), 'Pavel', 'Kopecký', 98123, 1000, 0),
((select max(investor_id) + 1 from investors i), 'Otokar', 'Mueller', 1000, 103400, 234123),
((select max(investor_id) + 1 from investors i), 'Meghan', 'Marble', 0, 1276, 552),
((select max(investor_id) + 1 from investors i), 'Boris', 'Johnson', 0, 87456, 31452),
((select max(investor_id) + 1 from investors i), 'Inga', 'Berg', 120345, 8944, 66643),
((select max(investor_id) + 1 from investors i), 'Petr', 'Svetr', 13443, 10000, 2364),
((select max(investor_id) + 1 from investors i), 'Libuše', 'Mizerná', 55286, 340533, 12343),
((select max(investor_id) + 1 from investors i), 'Bořivoj', 'Štěňátko', 776543, 990, 34560),
((select max(investor_id) + 1 from investors i), 'Jaroslav', 'Seifert', 543221, 323345, 0),
((select max(investor_id) + 1 from investors i), 'Božena', 'Hloupá', 0, 0, 10),
((select max(investor_id) + 1 from investors i), 'Frodo', 'Pytlík', 0, 100000, 323451),
((select max(investor_id) + 1 from investors i), 'Bilbo', 'Pytlík', 0, 43264, 23653),
((select max(investor_id) + 1 from investors i), 'Harry', 'Potter', 0, 987896, 23424),
((select max(investor_id) + 1 from investors i), 'Roald', 'Dahl', 432123, 0, 0),
((select max(investor_id) + 1 from investors i), 'Dahlia', 'Rosebergová', 5467432, 0, 0),
((select max(investor_id) + 1 from investors i), 'Paula', 'Linke', 17634530, 12343, 23422),
((select max(investor_id) + 1 from investors i), 'Olaf', 'Kristoff', 1234, 5555, 0),
((select max(investor_id) + 1 from investors i), 'Zayn', 'Malin', 0, 129990, 760522),
((select max(investor_id) + 1 from investors i), 'Agatha', 'Hempel', 43110, 65000, 0),
((select max(investor_id) + 1 from investors i), 'Alissa', 'Hanft', 90, 999911, 3340),
((select max(investor_id) + 1 from investors i), 'Květa', 'Růžová', 30000, 10000, 10)
((select max(investor_id) + 1 from investors i), 'Bětka', 'Veselá', 300199, 0, 1990)
((select max(investor_id) + 1 from investors i), 'Eva', 'Čechová', 7763, 0, 0),
((select max(investor_id) + 1 from investors i), 'Jan', 'Mustermann', 990, 32345, 1234),
((select max(investor_id) + 1 from investors i), 'Roman', 'Toman', 1234321, 0, 0),
((select max(investor_id) + 1 from investors i), 'Roman', 'Romanovič', 22353, 10000, 323451),
((select max(investor_id) + 1 from investors i), 'James', 'Cameron', 0, 43264, 1023653),
((select max(investor_id) + 1 from investors i), 'Tom', 'Blue', 340, 987896, 23424),
((select max(investor_id) + 1 from investors i), 'Jerry', 'Brown', 432123, 0, 134532),
((select max(investor_id) + 1 from investors i), 'Daniel', 'Burthey', 0, 1468990, 0),
((select max(investor_id) + 1 from investors i), 'Miluše', 'Vlaštovková', 3453, 12343, 23422),
((select max(investor_id) + 1 from investors i), 'Olga', 'Olivová', 6660, 5555, 0),
((select max(investor_id) + 1 from investors i), 'Jan', 'Fišer', 0, 129990, 76522),
((select max(investor_id) + 1 from investors i), 'Bořek', 'Stavitel', 0, 65000, 0),
((select max(investor_id) + 1 from investors i), 'Mojmír', 'Neznaboh', 0, 999911, 456600),
((select max(investor_id) + 1 from investors i), 'Dobroslav', 'Ukrutný', 0, 10000, 1990)
((select max(investor_id) + 1 from investors i), 'Gustav', 'Vousatý', 300100, 430, 1990)
;
